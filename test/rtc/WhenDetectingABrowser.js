...
define([
    ...
    var firefox36UserAgents = [
        'Mozilla/5.0 (Windows NT 6.3; rv:36.0) Gecko/20100101 Firefox/36.0'
    ];
    var safari7UserAgents = [
        'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A'
    ];
    var safari6UserAgents = [
        'Mozilla/5.0 (iPad; CPU OS 6_0 like Mac OS X) AppleWebKit/536.26 (KHTML, like Gecko) Version/6.0 Mobile/10A5355d Safari/8536.25'
    ];
    var safari5UserAgents = [
        // 5.1.7
    ...
    var opera27UserAgents = [
        'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_10_2) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/40.0.2214.91 Safari/537.36 OPR/27.0.1689.54'
    ];
    var opera12UserAgents = [
        // 12.16
    ...
    var ie8UserAgents = [
        // 10.0 in 8.0 compatibility view
...
// 7.0
    ...
    describe('When detecting the browser', function () {
        it('detects Chrome 41', function () {
            _.forEach(chrome41UserAgents, function (ua) {
                var detect = new DetectBrowser(ua).detect();
                expect(detect.browser).to.be.equal('Chrome');
                expect(detect.version).to.be.equal(41);
            });
        });
        it('detects FireFox 36', function () {
            _.forEach(firefox36UserAgents, function (ua) {
                var detect = new DetectBrowser(ua).detect();
                expect(detect.browser).to.be.equal('Firefox');
                expect(detect.version).to.be.equal(36);
            });
        });
        it('detects Safari 7', function () {
            _.forEach(safari7UserAgents, function (ua) {
                var detect = new DetectBrowser(ua).detect();
                expect(detect.browser).to.be.equal('Safari');
                expect(detect.version).to.be.equal(7);
            });
        });
        it('detects Safari 6', function () {
            _.forEach(safari6UserAgents, function (ua) {
                var detect = new DetectBrowser(ua).detect();
                expect(detect.browser).to.be.equal('Safari');
                expect(detect.version).to.be.equal(6);
            });
        });
        it('detects Safari 5', function () {
            _.forEach(safari5UserAgents, function (ua) {
                var detect = new DetectBrowser(ua).detect();
                expect(detect.browser).to.be.equal('Safari');
                expect(detect.version).to.be.equal(5);
            });
        });
        it('detects Opera 27', function () {
            _.forEach(opera27UserAgents, function (ua) {
                var detect = new DetectBrowser(ua).detect();
                expect(detect.browser).to.be.equal('Opera');
                expect(detect.version).to.be.equal(27);
            });
        });
        it('detects Opera 12', function () {
        ...
        it('detects IE 11', function () {
            _.forEach(ie11UserAgents, function (ua) {
                var detect = new DetectBrowser(ua).detect();
                expect(detect.browser).to.be.equal('IE');
                expect(detect.version).to.be.equal(11);
            });
        });
        it('detects IE 10', function () {
            _.forEach(ie10UserAgents, function (ua) {
                var detect = new DetectBrowser(ua).detect();
                expect(detect.browser).to.be.equal('IE');
                expect(detect.version).to.be.equal(10);
            });
        });
        it('detects IE 9', function () {
            _.forEach(ie9UserAgents, function (ua) {
                var detect = new DetectBrowser(ua).detect();
                expect(detect.browser).to.be.equal('IE');
                expect(detect.version).to.be.equal(9);
            });
        });
        it('detects IE 8', function () {
            _.forEach(ie8UserAgents, function (ua) {
                var detect = new DetectBrowser(ua).detect();
                expect(detect.browser).to.be.equal('IE');
                expect(detect.version).to.be.equal(8);
            });
        });
        it('detects IE 7', function () {
            _.forEach(ie7UserAgents, function (ua) {
                var detect = new DetectBrowser(ua).detect();
                expect(detect.browser).to.be.equal('IE');
                expect(detect.version).to.be.equal(7);
            });
        });
        it('detects IE 6', function () {
            _.forEach(ie6UserAgents, function (ua) {
                var detect = new DetectBrowser(ua).detect();
                expect(detect.browser).to.be.equal('IE');
                expect(detect.version).to.be.equal(6);
            });
